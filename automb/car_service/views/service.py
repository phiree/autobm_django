...
from ..models import Supplier,Service,ServiceDetail
...
class ServiceList(ListView):
    model=ServiceDetail
    template_name = 'car_service/siteadmin/service/service_list.html'



class ServiceUpdate(UpdateView):
    model=ServiceDetail
    template_name = 'car_service/siteadmin/service/service_update.html'
...
def service_create_update(request,id):
    ...
    return render(request,'car_service/siteadmin/service/service_create.html',
        {
