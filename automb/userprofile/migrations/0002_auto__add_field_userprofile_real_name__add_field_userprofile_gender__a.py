...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('userprofile_userprofile', 'real_name',
                      self.gf('django.db.models.fields.CharField')(null=True, max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.gender'
        db.add_column('userprofile_userprofile', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='m', max_length=2),
                      keep_default=False)

        # Adding field 'UserProfile.email'
        db.add_column('userprofile_userprofile', 'email',
                      self.gf('django.db.models.fields.EmailField')(null=True, max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.real_name'
        db.delete_column('userprofile_userprofile', 'real_name')

        # Deleting field 'UserProfile.gender'
        db.delete_column('userprofile_userprofile', 'gender')

        # Deleting field 'UserProfile.email'
        db.delete_column('userprofile_userprofile', 'email')
    ...
    models = {
        ...
        'userprofile.userprofile': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'null': 'True', 'max_length': '100', 'blank': 'True'}),
            'gender': ('django.db.models.fields.CharField', [], {'default': "'m'", 'max_length': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '200'}),
            'real_name': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '20', 'blank': 'True'}),
